...
declare module '#convex/api' {
  export * from '${generatedApiImport}'
}
`,
  }, { nitro: true, nuxt: true })
}
...
`,
  ...
  addImports([
    { name: 'useConvexStorage', from: '#convex/storage' },
    { name: 'useConvexUpload', from: '#convex/storage' },
  ])
}
...
function setupConvexR2(nuxt: Nuxt, resolve: (path: string) => string): void {
  const template = addTemplate({
    filename: 'convex/r2.mjs',
    getContents: () => `// Auto-generated by nuxt-convex
export * from '@convex-dev/r2/vue'
`,
    write: true,
  })

  addTypeTemplate({
    filename: 'types/convex-r2.d.ts',
    getContents: () => `// Auto-generated by nuxt-convex
declare module '#convex/r2' {
  export * from '@convex-dev/r2/vue'
}
`,
  }, { nitro: true, nuxt: true })

  nuxt.options.alias['#convex/r2'] = template.dst
