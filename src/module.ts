...
import { defineNuxtModule, createResolver, addPlugin, addTemplate, addTypeTemplate, addImportsDir } from '@nuxt/kit'
...
async function setupConvexStorage(nuxt: Nuxt, resolve: (path: string) => string) {
...
async function scaffoldStorageFunctions(nuxt: Nuxt) {
...
function addConvexDevTools(nuxt: Nuxt, config: ResolvedConvexConfig) {
