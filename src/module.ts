...
function resolveConfig(options: ConvexConfig): ResolvedConvexConfig {
  ...
  return defu(options, { url, dir: 'convex', storage: false, r2: false }) as ResolvedConvexConfig
}
...
export { useConvexPaginatedQuery } from '${resolve('./runtime/composables/useConvexPaginatedQuery')}'
`,
    write: true,
  })
...
declare module '#convex' {
  ...
  export function useConvexPaginatedQuery<Query extends FunctionReference<'query'>>(
    query: Query,
