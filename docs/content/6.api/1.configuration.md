...
- If the resolved directory comes from an installed dependency layer, scaffolding falls back to the project layer and logs a warning that points to `convex.dir`.
