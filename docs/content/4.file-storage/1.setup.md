...
When your app extends a Nuxt layer, the scaffold targets the resolved Convex directory automatically. Use `convex.dir` if your Convex files live somewhere other than `convex/`.
