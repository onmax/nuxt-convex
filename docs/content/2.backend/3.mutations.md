...
The mutation returns the new document's ID.
...
Mutations are transactional. All database operations within a mutation either succeed together or fail together. You can read and write multiple documents atomically:
